const switchThemeBtn = document.querySelector('.button-theme');
const switchThemeBtnCercle = document.querySelector('.button-theme-cercle');
const moonSvg = document.querySelector('.moon-svg');
const sunSvg = document.querySelector('.sun-svg');

const switchThemeMobileBtn = document.querySelector('.mobile-button-theme');
const switchThemeMobileBtnCercle = document.querySelector(
  '.mobile-button-theme-cercle'
);
...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  setTimeout(() => {
    if (theme === `bright`) {
      switchThemeBtnCercle.style.backgroundColor = 'white';
      switchThemeBtnCercle.style.left = '15px';
      themeColor = 'white';
      sunSvg.style.fill = 'white';
      moonSvg.style.fill = 'transparent';

      switchThemeMobileBtnCercle.style.backgroundColor = 'white';
      switchThemeMobileBtnCercle.style.left = '15px';
      mobileSunSvg.style.fill = 'white';
      mobileMoonSvg.style.fill = 'transparent';
...
switchThemeBtn.addEventListener('click', () => {
  if (themeColor === 'black') {
    ...
    switchThemeBtnCercle.style.backgroundColor = 'rgba(255, 255, 255, 0.5)';
    switchThemeBtnCercle.style.left = '-1px';
    themeColor = 'black';
    sunSvg.style.fill = 'transparent';
    moonSvg.style.fill = 'lightgray';
    themeSwitchFoo();
    themeSwitchFooAsync();
  }
});

switchThemeMobileBtn.addEventListener('click', () => {
  if (themeColor === 'black') {
    switchThemeMobileBtnCercle.style.backgroundColor = 'white';
    switchThemeMobileBtnCercle.style.left = '15px';
    themeColor = 'white';
    ...
    switchThemeMobileBtnCercle.style.backgroundColor =
      'rgba(255, 255, 255, 0.5)';
    switchThemeMobileBtnCercle.style.left = '-1px';
    themeColor = 'black';
    mobileSunSvg.style.fill = 'transparent';
    mobileMoonSvg.style.fill = 'lightgray';
    themeSwitchFoo();
    themeSwitchFooAsync();
  }
});
...
function themeSwitchFoo() {
  if (themeColor === 'white') {
    ...
    sectionsElements.backgroundItems.forEach(item => {
      item.classList.add('transparent-bright');
    });
    sectionsElements.heroTitle.classList.add('hero-title-bright');
    sectionsElements.menuList.classList.add('menu-list-bright');
    sectionsElements.contacts.forEach(item => {
      item.classList.add('contacts-bright');
    });
    sectionsElements.socialMediaListItems.forEach(item => {
      item.classList.add('social-media-list-item-bright');
    });
    sectionsElements.sectionsLinks.forEach(item => {
      item.classList.add('sections-link-bright');
    });
    sectionsElements.aboutMeWrapperText.classList.add(
      'about-me-wrapper-text-bright'
    );
    sectionsElements.aboutMeWrapperTextGray.classList.add(
      'about-me-wrapper-text-grey-bright'
    );
    sectionsElements.aboutMeAcTrigger.forEach(item => {
    ...
    sectionsElements.acText.forEach(item => {
      item.classList.add('ac-text-bright');
    });
    sectionsElements.acInfoBlocks.forEach(item => {
      item.classList.add('ac-bright');
    });
    sectionsElements.aboutMeSwiperSlideItems.forEach(item => {
      item.classList.add('about-me-swiper-slide-bright');
    });
    sectionsElements.benefitsTitle.classList.add('benefits-title-bright');
    sectionsElements.benefitsItems.forEach(item => {
      item.classList.add('benefits-item-bright');
    });
    ...
    sectionsElements.projectDivDesign.forEach(item => {
      item.classList.add('project-div-design-bright');
    });
    sectionsElements.projectBtnSwapLeft.classList.add(
      'project-btn-swap-left-bright'
    );
    sectionsElements.projectBtnSwapRight.classList.add(
      'project-btn-swap-right-bright'
    );
    sectionsElements.faqMainTitle.classList.add('faq-main-title-bright');
    sectionsElements.fqaTitles.forEach(item => {
      item.classList.add('fqa-title-bright');
    });
    sectionsElements.fqaText.forEach(item => {
      item.classList.add('fqa-text-bright');
    });
    sectionsElements.faqBtns.forEach(item => {
      item.classList.add('faq-btn-bright');
    });
    sectionsElements.faqIcons.forEach(item => {
      item.classList.add('faq-icon-bright');
    });
    sectionsElements.faqListItems.forEach(item => {
      item.classList.add('faq-list-item-bright');
    });
    sectionsElements.reviews__h2.classList.add('reviews__h2-bright');
    sectionsElements.reviews__arrow_left.classList.add(
      'reviews__arrow-left-bright'
    );
    sectionsElements.reviews__arrow_right.classList.add(
      'reviews__arrow-right-bright'
    );
    sectionsElements.footer.classList.add('remove-before');
    sectionsElements.footerHeader.classList.add('footer-header-bright');
    sectionsElements.formInput.forEach(item => {
      item.classList.add('form-input-bright');
    });
    sectionsElements.link.forEach(item => {
      item.classList.add('link-bright');
    });
    ...
    sectionsElements.burgerNavLink.forEach(item => {
      item.classList.add('burger-nav-link-bright');
    });
    ...
    sectionsElements.backgroundItems.forEach(item => {
      item.classList.remove('transparent-bright');
    });
    sectionsElements.heroTitle.classList.remove('hero-title-bright');
    sectionsElements.menuList.classList.remove('menu-list-bright');
    sectionsElements.contacts.forEach(item => {
      item.classList.remove('contacts-bright');
    });
    sectionsElements.socialMediaListItems.forEach(item => {
      item.classList.remove('social-media-list-item-bright');
    });
    sectionsElements.sectionsLinks.forEach(item => {
      item.classList.remove('sections-link-bright');
    });
    sectionsElements.aboutMeWrapperText.classList.remove(
      'about-me-wrapper-text-bright'
    );
    sectionsElements.aboutMeWrapperTextGray.classList.remove(
      'about-me-wrapper-text-grey-bright'
    );
    sectionsElements.aboutMeAcTrigger.forEach(item => {
    ...
    sectionsElements.acText.forEach(item => {
      item.classList.remove('ac-text-bright');
    });
    sectionsElements.acInfoBlocks.forEach(item => {
      item.classList.remove('ac-bright');
    });
    sectionsElements.aboutMeSwiperSlideItems.forEach(item => {
      item.classList.remove('about-me-swiper-slide-bright');
    });
    sectionsElements.benefitsTitle.classList.remove('benefits-title-bright');
    sectionsElements.benefitsItems.forEach(item => {
      item.classList.remove('benefits-item-bright');
    });
    ...
    sectionsElements.projectDivDesign.forEach(item => {
      item.classList.remove('project-div-design-bright');
    });
    sectionsElements.projectBtnSwapLeft.classList.remove(
      'project-btn-swap-left-bright'
    );
    sectionsElements.projectBtnSwapRight.classList.remove(
      'project-btn-swap-right-bright'
    );
    sectionsElements.faqMainTitle.classList.remove('faq-main-title-bright');
    sectionsElements.fqaTitles.forEach(item => {
      item.classList.remove('fqa-title-bright');
    });
    sectionsElements.fqaText.forEach(item => {
      item.classList.remove('fqa-text-bright');
    });
    sectionsElements.faqBtns.forEach(item => {
      item.classList.remove('faq-btn-bright');
    });
    sectionsElements.faqIcons.forEach(item => {
      item.classList.remove('faq-icon-bright');
    });
    sectionsElements.faqListItems.forEach(item => {
      item.classList.remove('faq-list-item-bright');
    });
    sectionsElements.reviews__h2.classList.remove('reviews__h2-bright');
    sectionsElements.reviews__arrow_left.classList.remove(
      'reviews__arrow-left-bright'
    );
    sectionsElements.reviews__arrow_right.classList.remove(
      'reviews__arrow-right-bright'
    );
    ...
    sectionsElements.formInput.forEach(item => {
      item.classList.remove('form-input-bright');
    });
    sectionsElements.link.forEach(item => {
      item.classList.remove('link-bright');
    });
    sectionsElements.burgerOpenIcon.classList.remove('burger-open-icon-bright');
    sectionsElements.burgerCloseIcon.classList.remove(
      'burger-close-icon-bright'
    );
    sectionsElements.burgerNavLink.forEach(item => {
      item.classList.remove('burger-nav-link-bright');
    });
...
async function themeSwitchFooAsync() {
  ...
  if (themeColor === 'white') {
    reviews__items.forEach(item => {
      item.classList.add('reviews__item-bright');
    });
    reviews__img.forEach(item => {
      item.classList.add('reviews__img-bright');
    });
    reviews__h3.forEach(item => {
      item.classList.add('reviews__h3-bright');
    });
    reviews__descr.forEach(item => {
      item.classList.add('reviews__descr-bright');
    });
  } else {
    reviews__items.forEach(item => {
      item.classList.remove('reviews__item-bright');
    });
    reviews__img.forEach(item => {
      item.classList.remove('reviews__img-bright');
    });
    reviews__h3.forEach(item => {
      item.classList.remove('reviews__h3-bright');
    });
    reviews__descr.forEach(item => {
      item.classList.remove('reviews__descr-bright');
    });
  }
}
